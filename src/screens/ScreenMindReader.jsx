...
const options = [
  {
    ...
    signal: 34,
    signalLabel: "Weak signal — empty mind detected",
    thoughts: [
      "Mind completely blank. Either very zen or in sleep mode.",
      "Signal faint. Possibly thinking about absolutely nothing.",
      "Brain activity: minimal. This is actually impressive.",
    ],
  },
  {
    label: "Bohot kuch soch rahi hoon 🌀",
    signal: 92,
    signalLabel: "Strong signal — overthinking detected",
    thoughts: [
      "Too many thoughts. Machine overwhelmed. Filing 47 tabs.",
      "Thought traffic jam detected. Signal overloaded.",
      "Brain running 12 background processes simultaneously.",
    ],
  },
  {
    label: "Kuch important soch rahi hoon 🤔",
    signal: 67,
    signalLabel: "Moderate signal — selective access",
    thoughts: [
      "Important thought detected. Classification: Top Secret.",
      "Signal intercepted but encrypted. Content: Unknown.",
      "Thought exists. Details: Classified 🔒",
    ],
  },
  {
    label: "Tumhare baare mein soch rahi hoon 👀",
    signal: 99,
    signalLabel: "Maximum signal — suspicious clarity",
    thoughts: [
      "Crystal clear signal. Subject thinking about this app.",
      "High confidence read: Curiosity level — dangerously high.",
      "Thought confirmed. Investigation team: not surprised.",
    ],
  },
];
